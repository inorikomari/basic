...
(function($) {
	...
	function _c(_d) {
		...
		if (_e.height != "auto") {
			var _1a = _11 - _14.children("div.datagrid-header").outerHeight(true)
					- _14.children("div.datagrid-footer").outerHeight(true)
					- _f.children("div.datagrid-toolbar").outerHeight(true);
	...
	function _29(_2a, _2b) {
		...
		return {
			...
			dc : {
				...
				view1 : _35,
				view2 : _36,
				header1 : _35.children("div.datagrid-header").children("div.datagrid-header-inner"),
				header2 : _36.children("div.datagrid-header").children("div.datagrid-header-inner"),
				body1 : _35.children("div.datagrid-body").children("div.datagrid-body-inner"),
				body2 : _36.children("div.datagrid-body"),
				footer1 : _35.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
				footer2 : _36.children("div.datagrid-footer").children("div.datagrid-footer-inner")
			}
		};
	}
	;
	...
	function _3c(_3d) {
		...
		var dc = _3e.dc;
		var _40 = _3e.panel;
		_40.panel($.extend({}, _3f, {
			id : null,
			doSize : false,
			onResize : function(_41, _42) {
				setTimeout(function() {
		...
		if (_3f.pagination) {
			...
			_46.pagination({
				pageNumber : _3f.pageNumber,
				pageSize : _3f.pageSize,
				pageList : _3f.pageList,
		...
		function _43(_4a, _4b, _4c) {
			...
			if (_4c && _3f.rownumbers) {
				var td = $("<td rowspan=\"" + _3f.frozenColumns.length
	...
	function _33(_80, _81) {
		...
		function fix(_85) {
			...
			var _87 = _86.styleSheet ? _86.styleSheet
					: (_86.sheet || document.styleSheets[document.styleSheets.length - 1]);
			...
			if (col && col.editor) {
				...
				if (_114) {
					...
					$.data(cell[0], "datagrid.editor", {
						actions : _114,
						target : _114.init(cell.find("td"), _113),
						field : _111,
						type : _112,
						oldHtml : _115
					});
		...
		return this.each(function() {
			...
			if (_147) {
				...
				opts = $.extend({}, $.extend({}, $.fn.datagrid.defaults, {
					queryParams : {}
				}), $.fn.datagrid.parseOptions(this), _145);
	...
	$.fn.datagrid.methods = {
		options : function(jq) {
			...
			var opts = $.extend(_18e, {
				width : _18f.width,
				height : _18f.height,
				closed : _18f.closed,
				collapsed : _18f.collapsed,
				minimized : _18f.minimized,
				maximized : _18f.maximized
			});
			var _190 = jq.datagrid("getPager");
			if (_190.length) {
				var _191 = _190.pagination("options");
				$.extend(opts, {
					pageNumber : _191.pageNumber,
					pageSize : _191.pageSize
				});
			}
			return opts;
		},
	...
	$.fn.datagrid.parseOptions = function(_1b4) {
		var t = $(_1b4);
		return $.extend({}, $.fn.panel.parseOptions(_1b4), $.parser.parseOptions(_1b4, [ "url", "toolbar", "idField",
	...
	var _1b5 = {
		...
		renderRow : function(_1c4, _1c5, _1c6, _1c7, _1c8) {
			...
			if (_1c6 && opts.rownumbers) {
				...
				cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">" + _1c9
						+ "</div></td>");
			}
			for ( var i = 0; i < _1c5.length; i++) {
				...
				if (col) {
					...
					cc.push("\">");
					if (col.checkbox) {
						cc.push("<input type=\"checkbox\" name=\"" + _1ca + "\" value=\""
								+ (_1c8[_1ca] != undefined ? _1c8[_1ca] : "") + "\"/>");
					} else {
						if (col.formatter) {
		...
		insertRow : function(_1d4, _1d5, row) {
			...
			var tr1 = "<tr class=\"datagrid-row\" datagrid-row-index=\"" + _1d5 + "\">"
					+ this.renderRow.call(this, _1d4, _1d6, true, _1d5, row) + "</tr>";
			var tr2 = "<tr class=\"datagrid-row\" datagrid-row-index=\"" + _1d5 + "\">"
					+ this.renderRow.call(this, _1d4, _1d7, false, _1d5, row) + "</tr>";
			if (_1d5 >= data.rows.length) {
				if (data.rows.length) {
					opts.finder.getTr(_1d4, "", "last", 1).after(tr1);
					opts.finder.getTr(_1d4, "", "last", 2).after(tr2);
				} else {
					dc.body1.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>" + tr1
							+ "</tbody></table>");
					dc.body2.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>" + tr2
							+ "</tbody></table>");
				}
			} else {
	...
	$.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
		...
		editors : _149,
		finder : {
			getTr : function(_1e2, _1e3, type, _1e4) {
				type = type || "body";
				_1e4 = _1e4 || 0;
