 ...
 */
@Table("Sys_User")
public class User extends WrapSupport implements Serializable, AttachableEntity, Comparable<User>, Treeable, Dictable {
    private static final long serialVersionUID = -6909410061423195974L;
    
	@Override
	public Map<String, String> getDictFieldMap() {
		Map<String, String> fm = new HashMap<String, String>();
        fm.put("department",  "departmentText");
        return fm;
	}
    ...
    @Id(auto=false)
    @Column
    @Prev(@SQL("select seq_user.nextval from dual"))
    protected Long id;
     ...
     */
    @Column
    @ColDefine(notNull = true, type = ColType.VARCHAR, width = 50, precision = 0)
    ...
    public TreeItem toTreeItem() {
        return TreeItem.item(id, username, getDepartment());
    }
