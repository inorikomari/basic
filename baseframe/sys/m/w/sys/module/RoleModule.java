...
public class RoleModule extends BasicModule {
    ...
    public Result add(@Param("..") Role role) {
    	LogHelper.saveLog(SysLog.ACTION_INSERT, "新增角色:【"+role.getName()+"】");
    ...
    public Result update(@Param("..") Role role) {
    	LogHelper.saveLog(SysLog.ACTION_UPDATE, "修改角色:【"+role.getName()+"】");
    ...
    public Result delete(Long id) {
    	...
    	LogHelper.saveLog(SysLog.ACTION_DELETE, "删除角色:【"+role.getName()+"】");
