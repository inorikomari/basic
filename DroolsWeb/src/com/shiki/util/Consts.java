...
public class Consts {
    ...
    private static Map<String, List<Options>> options = new HashMap<String, List<Options>>();
                ...
                if(!Strings.isBlank(line)){
                    ...
                    if(!line.startsWith(SP) && line.indexOf(EQ)>0){
                        ...
                        for(String v : vs){
                            ...
                            ops.add(new Options(k[0].trim(), k[1].trim()));
                        }
     ...
     * @return
     */
    public static List<Options> options(String f){
